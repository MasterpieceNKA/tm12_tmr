...
static const rclcpp::Logger LOGGER = rclcpp::get_logger("demo_tm12_mtc");
...
MTCTaskNode::MTCTaskNode(const rclcpp::NodeOptions &options)
    : node_{std::make_shared<rclcpp::Node>("pick_placeready_place", options)}
{
}
...
void MTCTaskNode::setupPlanningScene()
{
  ...
  object.primitives[0].dimensions = {0.1, 0.015};

  geometry_msgs::msg::Pose pose;
  pose.position.x = 0.5;
  pose.position.y = -0.95;
...
mtc::Task MTCTaskNode::createTask()
{
  ...
  task.setProperty("world_frame", world_frame);
...
#pragma GCC diagnostic pop

  {
    ...
    task.properties().exposeTo(grasp->properties(), {"eef", "group", "ik_frame", "world_frame"});
    ...
    }
    {
      ...
      q = Eigen::AngleAxisd(M_PI, Eigen::Vector3d::UnitY()) *
  ...
  // generate place ready stage
  {
                                          ...
                                          {"eef", "group", "ik_frame", "world_frame"});
    {
      ...
      target_pose_msg.pose.position.y = -0.95;
